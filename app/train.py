...
def train_model():
    print("Fetching and preprocessing Employee Salary data...")
    ...
    mlflow.set_experiment("Employee_Salary_Prediction")

    with mlflow.start_run():
        print("Training Employee Salary regression pipeline...")
        ...
        if r2 > historical_best:
            ...
            print("Model not better than previous best. Keeping existing model.")

        if not MODEL_PATH.exists():
            print("No previous model exists. Saving current model as fallback...")
            with open(MODEL_PATH, "wb") as f:
                pickle.dump(pipeline, f)
